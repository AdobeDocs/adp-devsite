...
export const createClearDialog = () => {
  ...
  const description = createTag("p", {
    class: "chat-window-dialog-description",
  });
  description.textContent =
    "Are you sure you want to clear this conversation? All history will be deleted.";

  const buttons = createTag("div", { class: "chat-window-dialog-buttons" });
